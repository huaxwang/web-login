...
import com.soga.code.core.util.SysCode;
...
public class ParamInfo {
    ...
    public ResponseJSON getResponse(String param) {
        if (response != null) {
            response.getBody().setMessage(param + SysCode.PARAM_IS_ERROR.getMessage());
            response.getBody().setCode(SysCode.PARAM_IS_ERROR.getCode());
        }
        logger.info("the response json is :" + response);
        return response;
    }
